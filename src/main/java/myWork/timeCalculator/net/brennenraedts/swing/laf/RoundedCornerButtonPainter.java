...
public class RoundedCornerButtonPainter extends AbstractRegionPainter {
    //The available states that this painter will paint. 
    ...
    public RoundedCornerButtonPainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
    ...
    public RoundedCornerButtonPainter(JComponent c, int state) {
        super();
        this.ctx = new PaintContext(new Insets(7, 7, 7, 7), c.getSize(), false, null, Double.POSITIVE_INFINITY, 2.0);
        this.state = state;
    }
    ...
    protected RoundRectangle2D decodeRoundRect1() {
        roundRect.setRoundRect(decodeX(0.2857143f), //x
                ...
                getRounding(decodeX(2.7142859f) - decodeX(0.2857143f), decodeY(2.857143f) - decodeY(0.42857143f)), getRounding(decodeX(2.7142859f) - decodeX(0.2857143f), decodeY(2.857143f) - decodeY(0.42857143f))); //rounding
        return roundRect;
    }
    ...
    protected RoundRectangle2D decodeRoundRect2() {
        roundRect.setRoundRect(decodeX(0.2857143f), //x
                ...
                getRounding(decodeX(2.7142859f) - decodeX(0.2857143f), decodeY(2.7142859f) - decodeY(0.2857143f)), getRounding(decodeX(2.7142859f) - decodeX(0.2857143f), decodeY(2.7142859f) - decodeY(0.2857143f))); //rounding
        return roundRect;
    }
    ...
    protected RoundRectangle2D decodeRoundRect3() {
        roundRect.setRoundRect(decodeX(0.42857143f), //x
                ...
                getRounding(decodeX(2.5714285f) - decodeX(0.42857143f), decodeY(2.5714285f) - decodeY(0.42857143f)), getRounding(decodeX(2.5714285f) - decodeX(0.42857143f), decodeY(2.5714285f) - decodeY(0.42857143f))); //rounding
        return roundRect;
    }
    ...
    protected RoundRectangle2D decodeRoundRect4() {
        roundRect.setRoundRect(decodeX(0.08571429f), //x
                ...
                getRounding(decodeX(2.914286f) - decodeX(0.08571429f), decodeY(2.914286f) - decodeY(0.08571429f)), getRounding(decodeX(2.914286f) - decodeX(0.08571429f), decodeY(2.914286f) - decodeY(0.08571429f))); //rounding
        return roundRect;
    }
