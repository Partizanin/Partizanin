...
public class MainWindow2 extends JFrame {
    ...
    private MainWindow2() {
        ...
        textField2F.addKeyListener(keyListener2);
        textField1F.addKeyListener(keyListener2);
    ...
    KeyListener keyListener = new KeyAdapter() {
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if (key == KeyEvent.VK_ENTER) {
                ...
                enterFields1(textField1.getText(), textField2.getText(), labelMinus.getText(), labelPlus.getText());
            }
        }
        ...
        public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
            ...
            if (offs == 0) {
                ...
                if (textField1.getText().length() > 1) {
                    if (Integer.parseInt(textField1.getText().substring(1, 2)) >
                            3) {
                        return;
                    }
                }
            ...
            if (offs == 2 || offs == 5 || offs == 3 || offs == 6) {
            ...
            if (offs == 1 && textField1.getText().substring(0, 1).equals("2")) {
  ...
  /*        if (getLength() > 7 ){
        ...
        public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
            ...
            if (offs == 0) {
                ...
                if (textField2.getText().length() > 1) {
                    if (Integer.parseInt(textField2.getText().substring(1, 2)) >
                            3) {
                        return;
                    }
                }
            ...
            if (offs == 1 && textField2.getText().substring(0, 1).equals("2")) {
                if (Integer.parseInt(str) > 3) {
                    return;
                }
            }
    ...
    private void enterFields1(String field1, String field2, String operation1, String operation2) {

        boolean error;

        error = Boolean.parseBoolean(checkError(field1, field2));
        ...
        if (!error) {
            ...
            if (operation1.equals("")) {
                ...
                if (operation2.equals("+")) {
                    ...
                    labelEquals.setText(timePlus(field1, field2));
                } else {
                    labelEquals.setText(timeMinus(field1, field2));
                }
